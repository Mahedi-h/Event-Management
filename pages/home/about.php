            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <div class="page-header text-center">
                        ...
                        <h1>About  Dream Creation</h1>
                        <p>We are a professional event management company providing complete solution to all your needs of co ordination, planning, and execution of a wedding at the best possible price.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 side-nav" id="leftCol">
                    <div class="hide-side">
                        <ul class="listnone nav affix-top" id="sidebar">
                        ...
                        <div class="col-md-12 team-section" id="team">
                            ...
                            <div class="row team-section">
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="./about_files/team-pic1.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="./about_files/team-pic7.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="./about_files/team-pic8.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="./about_files/team-pic2.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
